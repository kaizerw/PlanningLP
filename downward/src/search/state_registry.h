...
struct HashStateID {
    size_t operator()(const StateID &v) const { return v.get_value(); }
};
...
class StateRegistry : public subscriber::SubscriberService<StateRegistry> {
    ...
    struct StateIDSemanticEqual {
        ...
        bool operator()(int lhs, int rhs) const {
            ...
            return equal(lhs_data, lhs_data + state_size, rhs_data);
        }
    };
    ...
    */
    ...
    using SOCStateIDSet = int_hash_set::IntHashSet<SOCStateIDSemanticHash,
                                                   SOCStateIDSemanticEqual>;
    ...
    */
    ...
    class const_iterator : public iterator<forward_iterator_tag, StateID> {
        /*
