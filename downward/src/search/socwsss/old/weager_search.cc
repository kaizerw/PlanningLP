...
namespace weager_search {
WEagerSearch::WEagerSearch(const Options &opts)
    : SearchEngine(opts),
...
void WEagerSearch::print_checkpoint_line(int g) const {
    cout << "[g=" << g << ", ";
    statistics.print_basic_statistics();
    cout << "]" << endl;
}

void WEagerSearch::print_statistics() const {
    statistics.print_detailed_statistics();
    search_space.print_statistics();
    pruning_method->print_statistics();
}

SearchStatus WEagerSearch::step() {
    ...
    ///////////////////////////////////////////////////////////////////
    cout << "%%" << endl;
    cout << "NODE: " << node.get_state_id() << endl << endl;
    cout << "FACTS: " << endl;
    node.get_state().dump_pddl();
    cout << endl << "G: " << node.get_g() << endl;
    cout << "%%" << endl;
    ///////////////////////////////////////////////////////////////////
    */
    ...
    */
    ...
    for (OperatorID op_id : applicable_ops) {
        ...
        if (succ_node.is_new()) {
            ...
            ///////////////////////////////////////////////////////////////////
            cout << "%%" << endl;
            cout << "EDGE: " << op.get_name() << endl;
            cout << "FROM: " << node.get_state_id() << endl;
            cout << "TO: " << succ_state.get_id() << endl;
            cout << "%%" << endl;
            ///////////////////////////////////////////////////////////////////
            ///////////////////////////////////////////////////////////////////
            cout << "%%" << endl;
            cout << "NODE: " << succ_state.get_id() << endl;
            succ_state.dump_pddl();
            cout << endl << "G: " << succ_g << endl;
            cout << "%%" << endl;
            ///////////////////////////////////////////////////////////////////
            */
...
pair<SearchNode, bool> WEagerSearch::fetch_next_node() {
...
void WEagerSearch::reward_progress() {
    // Boost the "preferred operator" open lists somewhat whenever
    // one of the heuristics finds a state with a new best h value.
    open_list->boost_preferred();
}

void WEagerSearch::dump_search_space() const {
    search_space.dump(task_proxy);
}

void WEagerSearch::start_f_value_statistics(EvaluationContext &eval_context) {
    if (f_evaluator) {
...
void WEagerSearch::update_f_value_statistics(const SearchNode &node) {
    if (f_evaluator) {
        /*
        ...
        */
        ...
        //////////////////////////////////////////////////////////////////////////////
        max_f_found = max(max_f_found, f_value);
        //////////////////////////////////////////////////////////////////////////////
    }
}
}
