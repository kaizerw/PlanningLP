...
#define LP_METHOD(X)                                                    \
    NO_RETURN X {                                                       \
        ABORT(                                                          \
            "LP method called but the planner was compiled without LP " \
            "support.\n"                                                \
...
struct LPVariable {
    ...
    LPVariable(double lower_bound, double upper_bound,
               double objective_coefficient, bool is_integer = false);
};
...
class LPSolver {
    ...
    */
    ...
    LP_METHOD(void load_problem(LPObjectiveSense sense,
